...
public class CustomerServiceImpl implements CustomerService{
	...
	@Override
	public OrderResponse getCustomerByMobile(Long mobile) throws CustomerEntityException {
		try
		{
			Customer _temp = customerRepository.findByMobile(mobile);
			return new OrderResponse(_temp.getCustomerId(),_temp.getName());
